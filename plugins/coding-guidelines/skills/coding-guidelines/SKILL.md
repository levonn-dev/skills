...
These restate the principles Andrej Karpathy stated about common LLM coding failure modes. Apply when writing, reviewing, or refactoring code. Use judgment for trivial scripts. These rules target high-stakes code where mistakes compound.
